...
import com.liferay.docs.backend.model.UsersModel;
...
/**
 * The base model implementation for the Users service. Represents a row in the &quot;Timekeeping_Users&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class UsersModelImpl extends BaseModelImpl<Users> implements UsersModel {
	 ...
	 */
	public static final String TABLE_NAME = "Timekeeping_Users";

	public static final Object[][] TABLE_COLUMNS = {
		{"id_", Types.INTEGER}, {"hovaten", Types.VARCHAR},
		{"userId", Types.BIGINT}, {"email", Types.VARCHAR},
		{"chucvu_id", Types.BIGINT}, {"trangthai", Types.BIGINT},
		{"phongban_id", Types.BIGINT}, {"ca_lam_id", Types.BIGINT},
		{"ca_lam_toi", Types.BIGINT}, {"ma_xac_nhan", Types.VARCHAR},
		{"zalo_id", Types.VARCHAR}, {"cham_cong_ngoai", Types.BIGINT},
		{"so_ngay_nghi_phep", Types.BIGINT}, {"phu_trach_phong", Types.INTEGER},
	...
	static {
		...
		columnBitmasks.put("chucvu_id", 16L);

		columnBitmasks.put("trangthai", 32L);

		columnBitmasks.put("phongban_id", 64L);

		columnBitmasks.put("ca_lam_id", 128L);

		columnBitmasks.put("ca_lam_toi", 256L);

		columnBitmasks.put("ma_xac_nhan", 512L);

		columnBitmasks.put("zalo_id", 1024L);

		columnBitmasks.put("cham_cong_ngoai", 2048L);

		columnBitmasks.put("so_ngay_nghi_phep", 4096L);

		columnBitmasks.put("phu_trach_phong", 8192L);
