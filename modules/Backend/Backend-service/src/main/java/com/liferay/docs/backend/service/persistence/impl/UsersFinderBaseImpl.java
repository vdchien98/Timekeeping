 ...
 * @generated
 */
public abstract class UsersFinderBaseImpl extends BasePersistenceImpl<Users> {

	public UsersFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return usersPersistence.getBadColumnNames();
	}
