...
import com.liferay.docs.backend.model.XinnghiModel;
...
/**
 * The base model implementation for the Xinnghi service. Represents a row in the &quot;Timekeeping_Xinnghi&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class XinnghiModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "Timekeeping_Xinnghi";
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("trangthai_kyso", Types.INTEGER);
	}

	public static final String TABLE_SQL_CREATE =
		"create table Timekeeping_Xinnghi (id_ INTEGER not null primary key,user_id LONG,tu_ngay DATE null,den_ngay DATE null,ly_do VARCHAR(75) null,chon_ly_do VARCHAR(75) null,trangthai INTEGER,nua_ngay INTEGER,so_ngay INTEGER,file_url VARCHAR(75) null,nguoi_huy LONG,created_at DATE null,updated_at DATE null,phongban_id LONG,trangthai_kyso INTEGER)";

	public static final String TABLE_SQL_DROP =
		"drop table Timekeeping_Xinnghi";

	public static final String ORDER_BY_JPQL = " ORDER BY xinnghi.id ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY Timekeeping_Xinnghi.id_ ASC";
	...
	static {
		...
		attributeGetterFunctions.put(
			"trangthai_kyso", Xinnghi::getTrangthai_kyso);
		attributeSetterBiConsumers.put(
			"trangthai_kyso",
			(BiConsumer<Xinnghi, Integer>)Xinnghi::setTrangthai_kyso);
	...
	public void setTrangthai_kyso(int trangthai_kyso) {
		...
		_trangthai_kyso = trangthai_kyso;
	}
	...
	public Object clone() {
		...
		xinnghiImpl.setTrangthai_kyso(getTrangthai_kyso());
	...
	public Xinnghi cloneWithOriginalValues() {
		...
		xinnghiImpl.setTrangthai_kyso(
			this.<Integer>getColumnOriginalValue("trangthai_kyso"));
	...
	public CacheModel<Xinnghi> toCacheModel() {
		...
		xinnghiCacheModel.trangthai_kyso = getTrangthai_kyso();
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put("trangthai_kyso", _trangthai_kyso);
	}
	...
	static {
		...
		columnBitmasks.put("trangthai_kyso", 16384L);
