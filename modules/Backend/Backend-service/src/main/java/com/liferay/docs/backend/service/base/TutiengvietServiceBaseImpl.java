...
import com.liferay.docs.backend.service.TutiengvietService;
import com.liferay.docs.backend.service.TutiengvietServiceUtil;
...
/**
 * Provides the base implementation for the tutiengviet remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.docs.backend.service.impl.TutiengvietServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.docs.backend.service.impl.TutiengvietServiceImpl
 * @generated
 */
public abstract class TutiengvietServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, TutiengvietService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TutiengvietService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TutiengvietServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TutiengvietService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		tutiengvietService = (TutiengvietService)aopProxy;

		_setServiceUtilService(tutiengvietService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TutiengvietService.class.getName();
	}
	...
	private void _setServiceUtilService(TutiengvietService tutiengvietService) {
		try {
			Field field = TutiengvietServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, tutiengvietService);
		}
	...
	@Reference
	protected com.liferay.docs.backend.service.TutiengvietLocalService
		tutiengvietLocalService;

	protected TutiengvietService tutiengvietService;
