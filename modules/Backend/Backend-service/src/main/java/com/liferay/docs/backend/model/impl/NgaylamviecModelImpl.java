...
import com.liferay.docs.backend.model.NgaylamviecModel;
...
/**
 * The base model implementation for the Ngaylamviec service. Represents a row in the &quot;Timekeeping_Ngaylamviec&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class NgaylamviecModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "Timekeeping_Ngaylamviec";
	...
	public static final String TABLE_SQL_CREATE =
		"create table Timekeeping_Ngaylamviec (id_ INTEGER not null primary key,nam INTEGER,thang INTEGER,so_ngay_lam_viec INTEGER,trangthai INTEGER,created_at DATE null,updated_at DATE null)";

	public static final String TABLE_SQL_DROP =
		"drop table Timekeeping_Ngaylamviec";

	public static final String ORDER_BY_JPQL = " ORDER BY ngaylamviec.id ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY Timekeeping_Ngaylamviec.id_ ASC";
