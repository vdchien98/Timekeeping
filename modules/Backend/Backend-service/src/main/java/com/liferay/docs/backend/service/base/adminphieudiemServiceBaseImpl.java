...
import com.liferay.docs.backend.service.adminphieudiemService;
import com.liferay.docs.backend.service.adminphieudiemServiceUtil;
...
/**
 * Provides the base implementation for the adminphieudiem remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.docs.backend.service.impl.adminphieudiemServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.docs.backend.service.impl.adminphieudiemServiceImpl
 * @generated
 */
public abstract class adminphieudiemServiceBaseImpl
	extends BaseServiceImpl
	implements adminphieudiemService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>adminphieudiemService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>adminphieudiemServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			adminphieudiemService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		adminphieudiemService = (adminphieudiemService)aopProxy;

		_setServiceUtilService(adminphieudiemService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return adminphieudiemService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = adminphieudiemServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, adminphieudiemService);
		}
	...
	@Reference
	protected com.liferay.docs.backend.service.adminphieudiemLocalService
		adminphieudiemLocalService;

	protected adminphieudiemService adminphieudiemService;
