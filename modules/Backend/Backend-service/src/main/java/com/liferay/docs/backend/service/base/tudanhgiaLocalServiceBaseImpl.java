...
import com.liferay.docs.backend.service.tudanhgiaLocalService;
...
/**
 * Provides the base implementation for the tudanhgia local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.docs.backend.service.impl.tudanhgiaLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.docs.backend.service.impl.tudanhgiaLocalServiceImpl
 * @generated
 */
public abstract class tudanhgiaLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, tudanhgiaLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>tudanhgiaLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>tudanhgiaLocalServiceUtil</code>.
	 */
	...
	public tudanhgia addtudanhgia(tudanhgia tudanhgia) {
		...
		return tudanhgiaPersistence.update(tudanhgia);
	}
	...
	public tudanhgia createtudanhgia(int id) {
		return tudanhgiaPersistence.create(id);
	}
	...
	public tudanhgia deletetudanhgia(int id) throws PortalException {
		return tudanhgiaPersistence.remove(id);
	}
	...
	public tudanhgia deletetudanhgia(tudanhgia tudanhgia) {
		return tudanhgiaPersistence.remove(tudanhgia);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return tudanhgiaPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			tudanhgia.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return tudanhgiaPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return tudanhgiaPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return tudanhgiaPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return tudanhgiaPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public tudanhgia fetchtudanhgia(int id) {
		return tudanhgiaPersistence.fetchByPrimaryKey(id);
	}
	...
	public tudanhgia gettudanhgia(int id) throws PortalException {
		return tudanhgiaPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(tudanhgiaLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(tudanhgia.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(tudanhgia.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return tudanhgiaPersistence.create(((Integer)primaryKeyObj).intValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return tudanhgiaLocalService.deletetudanhgia((tudanhgia)persistedModel);
	}

	@Override
	public BasePersistence<tudanhgia> getBasePersistence() {
		return tudanhgiaPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return tudanhgiaPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<tudanhgia> gettudanhgias(int start, int end) {
		return tudanhgiaPersistence.findAll(start, end);
	}
	...
	public int gettudanhgiasCount() {
		return tudanhgiaPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			tudanhgiaLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tudanhgiaLocalService = (tudanhgiaLocalService)aopProxy;

		_setLocalServiceUtilService(tudanhgiaLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return tudanhgiaLocalService.class.getName();
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = tudanhgiaLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, tudanhgiaLocalService);
		}
	...
	protected tudanhgiaLocalService tudanhgiaLocalService;
