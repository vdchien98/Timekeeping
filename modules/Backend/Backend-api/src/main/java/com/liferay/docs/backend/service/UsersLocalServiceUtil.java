 ...
 * <code>com.liferay.docs.backend.service.impl.UsersLocalServiceImpl</code> and
...
public class UsersLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.docs.backend.service.impl.UsersLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static void UpdateAllNhanVien(
		...
		getService().UpdateAllNhanVien(serviceContext);
	}

	public static Users updateData(
			int id,
			com.liferay.portal.kernel.service.ServiceContext serviceContext)
		throws PortalException {

		return getService().updateData(id, serviceContext);
	}
