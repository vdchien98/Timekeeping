...
/**
 * Provides the local service utility for Tutiengviet. This utility wraps
 * <code>com.liferay.docs.backend.service.impl.TutiengvietLocalServiceImpl</code> and
 ...
 * @generated
 */
public class TutiengvietLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.docs.backend.service.impl.TutiengvietLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Tutiengviet addTutiengviet(Tutiengviet tutiengviet) {
		return getService().addTutiengviet(tutiengviet);
	}
	 ...
	 */
	public static Tutiengviet createTutiengviet(int id) {
		return getService().createTutiengviet(id);
	}
	 ...
	 */
	public static Tutiengviet deleteTutiengviet(int id) throws PortalException {
		return getService().deleteTutiengviet(id);
	}
	 ...
	 * @return the tutiengviet that was removed
	 */
	public static Tutiengviet deleteTutiengviet(Tutiengviet tutiengviet) {
		return getService().deleteTutiengviet(tutiengviet);
	}
	...
	public static Tutiengviet fetchTutiengviet(int id) {
		return getService().fetchTutiengviet(id);
	}
	 ...
	 * @throws PortalException if a tutiengviet with the primary key could not be found
	 */
	public static Tutiengviet getTutiengviet(int id) throws PortalException {
		return getService().getTutiengviet(id);
	}
	 ...
	 */
	public static List<Tutiengviet> getTutiengviets(int start, int end) {
		return getService().getTutiengviets(start, end);
	}
	 ...
	 */
	public static int getTutiengvietsCount() {
		return getService().getTutiengvietsCount();
	}
	 ...
	 */
	public static Tutiengviet updateTutiengviet(Tutiengviet tutiengviet) {
		return getService().updateTutiengviet(tutiengviet);
	}

	public static TutiengvietLocalService getService() {
		return _service;
	}

	private static volatile TutiengvietLocalService _service;
