...
/**
 * The persistence utility for the xinchamcong service. This utility wraps <code>com.liferay.docs.backend.service.persistence.impl.XinchamcongPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class XinchamcongUtil {
	...
	public static Xinchamcong findByid_First(
		...
		throws com.liferay.docs.backend.exception.NoSuchXinchamcongException {
