...
/**
 * Provides the local service utility for adminphieudiem. This utility wraps
 * <code>com.liferay.docs.backend.service.impl.adminphieudiemLocalServiceImpl</code> and
 ...
 * @generated
 */
public class adminphieudiemLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.docs.backend.service.impl.adminphieudiemLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static adminphieudiem addadminphieudiem(
		adminphieudiem adminphieudiem) {

		return getService().addadminphieudiem(adminphieudiem);
	}

	public static adminphieudiem addcauhoi(
	 ...
	 */
	public static adminphieudiem createadminphieudiem(int id) {
		return getService().createadminphieudiem(id);
	}
	 ...
	 */
	public static adminphieudiem deleteadminphieudiem(
		adminphieudiem adminphieudiem) {

		return getService().deleteadminphieudiem(adminphieudiem);
	}
	 ...
	 */
	public static adminphieudiem deleteadminphieudiem(int id)
		throws PortalException {

		return getService().deleteadminphieudiem(id);
	}
	...
	public static adminphieudiem fetchadminphieudiem(int id) {
		return getService().fetchadminphieudiem(id);
	}
	 ...
	 * @throws PortalException if a adminphieudiem with the primary key could not be found
	 */
	public static adminphieudiem getadminphieudiem(int id)
		throws PortalException {

		return getService().getadminphieudiem(id);
	}
	 ...
	 */
	public static List<adminphieudiem> getadminphieudiems(int start, int end) {
		return getService().getadminphieudiems(start, end);
	}
	 ...
	 */
	public static int getadminphieudiemsCount() {
		return getService().getadminphieudiemsCount();
	}
	 ...
	 */
	public static adminphieudiem updateadminphieudiem(
		adminphieudiem adminphieudiem) {

		return getService().updateadminphieudiem(adminphieudiem);
	}

	public static adminphieudiemLocalService getService() {
		return _service;
	}

	private static volatile adminphieudiemLocalService _service;
