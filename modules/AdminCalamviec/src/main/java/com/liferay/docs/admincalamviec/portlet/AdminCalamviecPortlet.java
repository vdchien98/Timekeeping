package com.liferay.docs.admincalamviec.portlet;

import com.liferay.docs.admincalamviec.constants.AdminCalamviecPortletKeys;
...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=AdminCalamviec",
		"javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/admincalamviec/Calamviec.jsp",
		"javax.portlet.name=" + AdminCalamviecPortletKeys.ADMINCALAMVIEC,
		"javax.portlet.resource-bundle=content.Language",
		"javax.portlet.security-role-ref=power-user,user"
	},
	service = Portlet.class
)
public class AdminCalamviecPortlet extends MVCPortlet {
public void saveCaLamViec (ActionRequest request, ActionResponse response)  {
        ...
        System.out.println("da vao dc admin ca lam viec--------");
